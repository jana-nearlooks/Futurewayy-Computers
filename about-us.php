...
<title>Futurewayy - Aboutus</title>
                    ...
                    <div class="col-xl-8 col-lg-6">
                        <div class="about-content content-right">
                            ...
                            <span class="text-heading" style="text-align: justify;">Welcome to Futurewayy Computers,
                                ...
                                student, we're here to empower you with the right tools for enhanced productivity and
                                connectivity </span>
                            <div class="row">
                                <div class="col-xl-6">
                                    <p style="text-align: justify;">At Futurewayy, we've got your back when it comes to fixing tech troubles. Our
                                        Service and Repair team is here to help with all kinds of issues – whether your
                                        computer is running slow or you're dealing with pesky software problems.</p>
                                </div>
                                <div class="col-xl-6">
                                    <p class="mb--0" style="text-align: justify;">Hardware acting up? No problem. Our tech experts are skilled at
                                        identifying and repairing hardware issues. Plus, if you're looking to boost your
                                        device's performance, we can recommend and install the right upgrades tailored
                                        to your needs.</p>
                                </div>
                            </div>
                        </div>
                ...
                <div class="row row--20">
                    <div class="col-lg-4">
                        <div class="about-info-box">
                            ...
                            <div class="content">
                                <h6 class="title">10,000+ Happy Customer</h6>
                    ...
                    <div class="col-lg-4">
                        <div class="about-info-box">
                            ...
                            <div class="content">
                                <h6 class="title">10 Years of Experiences</h6>
                                <p>Empower your sales teams with industry
                                    tailored solutions that support.</p>
                            </div>
                        </div>
...
<!-- Mirrored from new.axilthemes.com/demo/template/etrade/about-us.php by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 07 Dec 2023 13:35:04 GMT -->
