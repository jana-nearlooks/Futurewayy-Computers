...
<head>
    ...
    <title>Futureway Computers</title>
    <meta name="robots" content="noindex, follow" />
    <meta name="description" content="Best Computer Sales and Services in Theni">
    <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
    <!-- Favicon -->
    <link rel="shortcut icon" type="image/x-icon" href="assets/images/logo/favicon.png" width="100">
...
<body class="sticky-header newsletter-popup-modal">
    ...
    <main class="main-wrapper mt-10">
                        ...
                        <div class="main-slider-content">
                            <div class="slider-content-activation-one">
                                <div class="single-slide slick-slide" data-sal="slide-up" data-sal-delay="400" data-sal-duration="800">
                                    ...
                                    <h1 class="title">Zebronics Gaming Console</h1>
                                    <div class="slide-action">
                                        <div class="shop-btn">
                                            <a href="our-products.php" class="axil-btn btn-bg-white"><i class="fal fa-eye"></i>View</a>
                                        </div>
                                ...
                                <div class="single-slide slick-slide">
                                    <span class="subtitle"><i class="fas fa-fire"></i> Hot Deal In This Week</span>
                                    <h1 class="title">Fingers Sound Bar</h1>
                                    <div class="slide-action">
                                        <div class="shop-btn">
                                            <a href="our-products.php" class="axil-btn btn-bg-white"><i class="fal fa-eye"></i>View</a>
                                        </div>
                                ...
                                <div class="single-slide slick-slide">
                                    <span class="subtitle"><i class="fas fa-fire"></i> Hot Deal In This Week</span>
                                    <h1 class="title">HP Smart Tank Series</h1>
                                    <div class="slide-action">
                                        <div class="shop-btn">
                                            <a href="our-products.php" class="axil-btn btn-bg-white"><i class="fal fa-eye"></i>View</a>
                                        </div>
                                        <div class="item-rating">
                                            ...
                                            <div class="single-slide slick-slide">
                                    <span class="subtitle"><i class="fas fa-fire"></i> Hot Deal In This Week</span>
                                    <h1 class="title">Lapcare Charger Adapters</h1>
                                    <div class="slide-action">
                                        <div class="shop-btn">
                                            <a href="our-products.php" class="axil-btn btn-bg-white"><i class="fal fa-eye"></i>View</a>
                                        </div>
                                ...
                                <div class="single-slide slick-slide">
                                    <span class="subtitle"><i class="fas fa-fire"></i> Hot Deal In This Week</span>
                                    <h1 class="title">Lapcare Pendrives</h1>
                                    <div class="slide-action">
                                        <div class="shop-btn">
                                            <a href="our-products.php" class="axil-btn btn-bg-white"><i class="fal fa-eye"></i>View</a>
                                        </div>
                        ...
                        <div class="main-slider-large-thumb">
                            <div class="slider-thumb-activation-one axil-slick-dots">
                                <div class="single-slide slick-slide" data-sal="slide-up" data-sal-delay="600" data-sal-duration="1500">
                                    <img src="assets/images/product/futurewayy/gaming console 2.png" alt="Product" >
                                    <div class="product-price">
                                        <span class="text">From</span>
                                        <span class="price-amount">Rs.70,000</span>
                                    </div>
                                </div>
                                <div class="single-slide slick-slide" data-sal="slide-up" data-sal-delay="600" data-sal-duration="1500">
                                    <img src="assets/images/product/futurewayy/fingers sound bar.png" alt="Product">
                                    <div class="product-price">
                                        <span class="text">From</span>
                                        <span class="price-amount">Rs.3,500</span>
                                    </div>
                                </div>
                                <div class="single-slide slick-slide">
                                    <img src="assets/images/product/futurewayy/hp printer.png" alt="Product">
                                    <div class="product-price">
                                        <span class="text">From</span>
                                        <span class="price-amount">Rs.16,000</span>
                                    </div>
                                </div>
                                <div class="single-slide slick-slide">
                                    <img src="assets/images/product/futurewayy/lapcare charger.png" alt="Product">
                                    <div class="product-price">
                                        <span class="text">From</span>
                                        <span class="price-amount">Rs.999.00</span>
                                    </div>
                                </div>
                                <div class="single-slide slick-slide">
                                    <img src="assets/images/product/futurewayy/pendrive.webp" alt="Product">
                                    <div class="product-price">
                                        <span class="text">From</span>
                                        <span class="price-amount">Rs.499.00</span>
                                    </div>
                                </div>
                                <div class="single-slide slick-slide">
                                    <img src="assets/images/product/futurewayy/web cam.png" alt="Product">
                                    <div class="product-price">
                                        <span class="text">From</span>
                                        <span class="price-amount">Rs.799.00</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-xl-5 col-lg-6">
                            <div class="poster-countdown-content">
                                ...
                                <a href="our-products.php" class="axil-btn btn-bg-primary">Check it Out!</a>
                            </div>
                        </div>
            ...
            <div class="container">
                        ...
                        <div class="row row--15">
                            <div class="col-xl-3 col-lg-4 col-sm-6 col-12 mb--30">
                                <div class="axil-product product-style-one">
                                    <div class="thumbnail">
                                        <a href="#">
                                            <img data-sal="zoom-out" data-sal-delay="200" data-sal-duration="800"  class="main-img" src="assets/images/product/main-product/17.jpg" alt="Product Images">
                                        ...
                                        <div class="product-hover-action">
                                            <ul class="cart-action">
                                                <li class="select-option">
                                                    <a href="our-products.php"><i class="far fa-eye"></i>
                                                        View Product
                                                    </a>
                                                </li>
                                            </ul>
                                    ...
                                    <div class="product-content">
                                        <div class="inner">
                                            ...
                                            <h5 class="title"><a href="#">SMPS</a></h5>
                                            <div class="product-price-variant">
                                                <span class="price current-price">Rs.766</span>
                                                <span class="price old-price">Rs.966.99</span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="col-xl-3 col-lg-4 col-sm-6 col-12 mb--30">
                                <div class="axil-product product-style-one">
                                    <div class="thumbnail">
                                        <a href="#">
                                            <img data-sal="zoom-out" data-sal-delay="300" data-sal-duration="800"  src="assets/images/product/main-product/18.jpg" alt="Product Images">
                                    ...
                                    <div class="inner">
                                            ...
                                            <h5 class="title"><a href="#">Azus Get Force Graphics Card</a></h5>
                                            <div class="product-price-variant">
                                                <span class="price current-price">Rs.766</span>
                                                <span class="price old-price">Rs.966.99</span>
                                            </div>
                            ...
                            <div class="col-xl-3 col-lg-4 col-sm-6 col-12 mb--30">
                                <div class="axil-product product-style-one">
                                    <div class="thumbnail">
                                        <a href="#">
                                            <img data-sal="zoom-out" data-sal-delay="400" data-sal-duration="800"  src="assets/images/product/main-product/19.png" alt="Product Images">
                                    ...
                                    <div class="inner">
                                            ...
                                            <h5 class="title"><a href="#">Quick Heal Internet Security </a></h5>
                                            <div class="product-price-variant">
                                                <span class="price current-price">Rs.766</span>
                                                <span class="price old-price">Rs.966.99</span>
                                            </div>
                            ...
                            <div class="col-xl-3 col-lg-4 col-sm-6 col-12 mb--30">
                                <div class="axil-product product-style-one">
                                    <div class="thumbnail">
                                        <a href="#">
                                            <img data-sal="zoom-out" data-sal-delay="500" data-sal-duration="800"  src="assets/images/product/main-product/4.jpg" alt="Product Images">
                                    ...
                                    <div class="product-content">
                                        <div class="inner">
                                            ...
                                            <h5 class="title"><a href="#">Giga Byte Graphics Card</a></h5>
                                            <div class="product-price-variant">
                                                <span class="price current-price">Rs.3999</span>
                                                <span class="price old-price">Rs.9200</span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="col-xl-3 col-lg-4 col-sm-6 col-12 mb--30">
                                <div class="axil-product product-style-one">
                                    <div class="thumbnail">
                                        <a href="#">
                                            <img data-sal="zoom-out" data-sal-delay="200" data-sal-duration="800" src="assets/images/product/main-product/5.jpg" alt="Product Images">
                                    ...
                                    <div class="inner">
                                            ...
                                            <h5 class="title"><a href="#">Gaming Joystick</a></h5>
                                            <div class="product-price-variant">
                                                <span class="price current-price">Rs.766</span>
                                                <span class="price old-price">Rs.966.99</span>
                                            </div>
                            ...
                            <div class="col-xl-3 col-lg-4 col-sm-6 col-12 mb--30">
                                <div class="axil-product product-style-one">
                                    <div class="thumbnail">
                                        <a href="#">
                                            <img data-sal="zoom-out" data-sal-delay="300" data-sal-duration="800"  src="assets/images/product/main-product/6.jpg" alt="Product Images">
                                        </a>
                                        <div class="label-block label-right">
                                            <div class="product-badget">20% Off</div>
                                        </div>
                                    ...
                                    <div class="product-content">
                                        ...
                                        <div class="product-rating">
                                            ...
                                            <h5 class="title"><a href="#">TP Link Wireless Adapter</a></h5>
                                            <div class="product-price-variant">
                                                <span class="price current-price">Rs.766</span>
                                                <span class="price old-price">Rs.966.99</span>
                                            </div>
                            ...
                            <div class="col-xl-3 col-lg-4 col-sm-6 col-12 mb--30">
                                <div class="axil-product product-style-one">
                                    <div class="thumbnail">
                                        <a href="#">
                                            <img data-sal="zoom-out" data-sal-delay="400" data-sal-duration="800" src="assets/images/product/main-product/7.jpg" alt="Product Images">
                                    ...
                                    <div class="inner">
                                            ...
                                            <h5 class="title"><a href="#">Quick Heal Antivirus Pro</a></h5>
                                            <div class="product-price-variant">
                                                <span class="price current-price">Rs.766</span>
                                                <span class="price old-price">Rs.966.99</span>
                                            </div>
                            ...
                            <div class="col-xl-3 col-lg-4 col-sm-6 col-12 mb--30">
                                <div class="axil-product product-style-one">
                                    <div class="thumbnail">
                                        <a href="#">
                                            <img data-sal="zoom-out" data-sal-delay="500" data-sal-duration="800"  src="assets/images/product/main-product/8.jpg" alt="Product Images">
                                        </a>
                                        <div class="label-block label-right">
                                            <div class="product-badget">20% Off</div>
                                        </div>
                                    ...
                                    <div class="inner">
                                            ...
                                            <h5 class="title"><a href="#">Epson Ink Bottles</a></h5>
                                            <div class="product-price-variant">
                                                <span class="price current-price">Rs.766</span>
                                                <span class="price old-price">Rs.966.99</span>
                                            </div>
                               ...
                               <div class="col-xl-3 col-lg-4 col-sm-6 col-12 mb--30">
                                <div class="axil-product product-style-one">
                                    <div class="thumbnail">
                                        <a href="#">
                                            <img data-sal="zoom-out" data-sal-delay="500" data-sal-duration="800"  src="assets/images/product/main-product/9.jpg" alt="Product Images">
                                        </a>
                                        <div class="label-block label-right">
                                            <div class="product-badget">20% Off</div>
                                        </div>
                                    ...
                                    <div class="inner">
                                            ...
                                            <h5 class="title"><a href="#">Intel Processors</a></h5>
                                            <div class="product-price-variant">
                                                <span class="price current-price">Rs.766</span>
                                                <span class="price old-price">Rs.966.99</span>
                                            </div>
                               ...
                               <div class="col-xl-3 col-lg-4 col-sm-6 col-12 mb--30">
                                <div class="axil-product product-style-one">
                                    <div class="thumbnail">
                                        <a href="#">
                                            <img data-sal="zoom-out" data-sal-delay="500" data-sal-duration="800"  src="assets/images/product/main-product/10.jpg" alt="Product Images">
                                        </a>
                                        <div class="label-block label-right">
                                            <div class="product-badget">20% Off</div>
                                        </div>
                                    ...
                                    <div class="inner">
                                            ...
                                            <h5 class="title"><a href="#">WD NVme SSD</a></h5>
                                            <div class="product-price-variant">
                                                <span class="price current-price">Rs.766</span>
                                                <span class="price old-price">Rs.966.99</span>
                                            </div>
                               ...
                               <div class="col-xl-3 col-lg-4 col-sm-6 col-12 mb--30">
                                <div class="axil-product product-style-one">
                                    <div class="thumbnail">
                                        <a href="#">
                                            <img data-sal="zoom-out" data-sal-delay="500" data-sal-duration="800"  src="assets/images/product/main-product/11.jpg" alt="Product Images">
                                        </a>
                                        <div class="label-block label-right">
                                            <div class="product-badget">20% Off</div>
                                        </div>
                                    ...
                                    <div class="inner">
                                            ...
                                            <h5 class="title"><a href="#">WD SATA SSD</a></h5>
                                            <div class="product-price-variant">
                                                <span class="price current-price">Rs.766</span>
                                                <span class="price old-price">Rs.966.99</span>
                                            </div>
                               ...
                               <div class="col-xl-3 col-lg-4 col-sm-6 col-12 mb--30">
                                <div class="axil-product product-style-one">
                                    <div class="thumbnail">
                                        <a href="#">
                                            <img data-sal="zoom-out" data-sal-delay="500" data-sal-duration="800"  src="assets/images/product/main-product/12.jpg" alt="Product Images">
                                        </a>
                                        <div class="label-block label-right">
                                            <div class="product-badget">20% Off</div>
                                        </div>
                                    ...
                                    <div class="inner">
                                            ...
                                            <h5 class="title"><a href="#">JBL Wireless Headset</a></h5>
                                            <div class="product-price-variant">
                                                <span class="price current-price">Rs.766</span>
                                                <span class="price old-price">Rs.966.99</span>
                                            </div>
                            ...
                            <div class="col-xl-3 col-lg-4 col-sm-6 col-12 mb--30">
                                <div class="axil-product product-style-one">
                                    ...
                                    <div class="inner">
                                            ...
                                            <h5 class="title"><a href="#">Gaming Jostick White</a></h5>
                                            <div class="product-price-variant">
                                                <span class="price current-price">Rs.766</span>
                                                <span class="price old-price">Rs.966.99</span>
                                            </div>
                            ...
                            <div class="col-xl-3 col-lg-4 col-sm-6 col-12 mb--30">
                                <div class="axil-product product-style-one">
                                    ...
                                    <div class="inner">
                                            ...
                                            <h5 class="title"><a href="#">Gaming Keyboard</a></h5>
                                            <div class="product-price-variant">
                                                <span class="price current-price">Rs.766</span>
                                                <span class="price old-price">Rs.966.99</span>
                                            </div>
                            ...
                            <div class="col-xl-3 col-lg-4 col-sm-6 col-12 mb--30">
                                <div class="axil-product product-style-one">
                                    ...
                                    <div class="inner">
                                            ...
                                            <h5 class="title"><a href="#">Logitech Web Cam</a></h5>
                                            <div class="product-price-variant">
                                                <span class="price current-price">Rs.766</span>
                                                <span class="price old-price">Rs.966.99</span>
                                            </div>
                            ...
                            <div class="col-xl-3 col-lg-4 col-sm-6 col-12 mb--30">
                                <div class="axil-product product-style-one">
                                    ...
                                    <div class="inner">
                                            ...
                                            <h5 class="title"><a href="#">2.1 System Speakers</a></h5>
                                            <div class="product-price-variant">
                                                <span class="price current-price">Rs.766</span>
                                                <span class="price old-price">Rs.966.99</span>
                                            </div>
                            ...
                            <div class="col-xl-3 col-lg-4 col-sm-6 col-12 mb--30">
                                <div class="axil-product product-style-one">
                                    ...
                                    <div class="inner">
                                            ...
                                            <h5 class="title"><a href="#">Zebronics Bluetooth Speakers</a></h5>
                                            <div class="product-price-variant">
                                                <span class="price current-price">Rs.766</span>
                                                <span class="price old-price">Rs.966.99</span>
                                            </div>
                            ...
                            <div class="col-xl-3 col-lg-4 col-sm-6 col-12 mb--30">
                                <div class="axil-product product-style-one">
                                    ...
                                    <div class="inner">
                                            ...
                                            <h5 class="title"><a href="#">Logitech Wireless Mouse</a></h5>
                                            <div class="product-price-variant">
                                                <span class="price current-price">Rs.766</span>
                                                <span class="price old-price">Rs.966.99</span>
                                            </div>
                ...
                <div class="row">
                    <div class="col-lg-12 text-center mt--20 mt_sm--0">
                        <a href="our-products.php" class="axil-btn btn-bg-lighter btn-load-more">View All Products</a>
                    </div>
                </div>
                ...
                <div class="testimonial-slick-activation testimonial-style-one-wrapper slick-layout-wrapper--20 axil-slick-arrow arrow-top-slide">
                    <div class="slick-single-layout testimonial-style-one">
                        <div class="review-speech">
                            <p style="text-align: justify;">“Absolutely thrilled with my recent purchase! Futurewayycomputers delivers top-notch computer gadgets with exceptional quality.“</p>
                        </div>
                        <div class="media">
                            <div class="thumbnail">
                            ...
                            <div class="media-body">
                                ...
                                <h6 class="title">Janakrishnamoorthy</h6>
                            </div>
                        </div>
                        <!-- End .thumbnail -->
                    </div>
                    ...
                    <div class="slick-single-layout testimonial-style-one">
                        <div class="review-speech">
                            <p style="text-align: justify;">“Fantastic experience shopping at Futurewayy Computers! The range of computer gadgets is impressive, and the service is unbeatable.“</p>
                        </div>
                        <div class="media">
                            <div class="thumbnail">
                                <img src="assets/images/testimonial/image-1.png" alt="testimonial image">
                    ...
                    <div class="slick-single-layout testimonial-style-one">
                        <div class="review-speech">
                            <p>“Kudos to Futurewayy Computers for their stellar products! Each purchase exceeds my expectations. Highly recommend to all tech enthusiasts!“</p>
                        </div>
                        <div class="media">
                            <div class="thumbnail">
                                <img src="assets/images/testimonial/image-1.png" alt="testimonial image">
                    ...
                    <div class="new-arrivals-product-activation slick-layout-wrapper--30 axil-slick-arrow  arrow-top-slide">
                        <div class="slick-single-layout">
                            <div class="axil-product product-style-two">
                                <div class="thumbnail">
                                    <a href="#">
                                        <img data-sal="zoom-out" data-sal-delay="200" data-sal-duration="500" src="assets/images/product/main-product/13.jpg" alt="Product Images">
                                    </a>
                                    <div class="label-block label-right">
                                ...
                                <div class="product-content">
                                    <div class="inner">
                                        ...
                                        <h5 class="title"><a href="#">Gaming Consoles </a></h5>
                                        <div class="product-price-variant">
                                            <span class="price old-price">Rs.2000/-</span>
                                            <span class="price current-price">Rs.999/-</span>
                                        </div>
                                             <div class="product-hover-action">
                                            <ul class="cart-action">
                                                <li class="select-option">
                        ...
                        <div class="slick-single-layout">
                            <div class="axil-product product-style-two">
                                <div class="thumbnail">
                                    <a href="#">
                                        <img data-sal="zoom-out" data-sal-delay="300" data-sal-duration="500" src="assets/images/product/main-product/14.jpg" alt="Product Images">
                                    </a>
                                </div>
                                <div class="product-content">
                                    <div class="inner">
                                        ...
                                        <h5 class="title"><a href="#">HP Smart Tank 585</a></h5>
                                        <div class="product-price-variant">
                                            <span class="price old-price">Rs.2000/-</span>
                                            <span class="price current-price">Rs.999/-</span>
                                        </div>
                                    ...
                                    <div class="product-hover-action">
                                        <ul class="cart-action">
                                            ...
                                            <li class="select-option"><a href="our-products.php"><i class="far fa-eye"></i> View Product</a></li>
                        ...
                        <div class="slick-single-layout">
                            <div class="axil-product product-style-two">
                                <div class="thumbnail">
                                    <a href="#">
                                        <img data-sal="zoom-out" data-sal-delay="400" data-sal-duration="500" src="assets/images/product/main-product/15.jpg" alt="Product Images">
                                    </a>
                                    <div class="label-block label-right">
                                ...
                                <div class="product-content">
                                    <div class="inner">
                                        ...
                                        <h5 class="title"><a href="#">lapcare Charger Adaptor</a></h5>
                                        <div class="product-price-variant">
                                            <span class="price old-price">Rs.2000/-</span>
                                            <span class="price current-price">Rs.999/-</span>
                                        </div>
                        ...
                        <div class="slick-single-layout">
                            <div class="axil-product product-style-two">
                                <div class="thumbnail">
                                    <a href="#">
                                        <img data-sal="zoom-out" data-sal-delay="500" data-sal-duration="500" src="assets/images/product/main-product/16.jpg" alt="Product Images">
                                    </a>
                                    <div class="label-block label-right">
                                ...
                                <div class="product-content">
                                    <div class="inner">
                                        ...
                                        <h5 class="title"><a href="#">Gaming CPU</a></h5>
                                        <div class="product-price-variant">
                                            <span class="price old-price">Rs.2000/-</span>
                                            <span class="price current-price">Rs.999/-</span>
                                        </div>
                        ...
                        <div class="col">
                            <div class="axil-product-list">
                                ...
                                <div class="product-content">
                                    ...
                                    <h6 class="product-title"><a href="#">HD Camera</a></h6>
                                    <div class="product-price-variant">
                                        <span class="price current-price">Rs.100.99</span>
                                    </div>
                                    <div class="product-cart">
                                        <a href="cart.php" class="cart-btn"><i class="fal fa-shopping-cart"></i></a>
                                        <a href="wishlist.php" class="cart-btn"><i class="fal fa-heart"></i></a>
                        ...
                        <div class="col">
                            <div class="axil-product-list">
                                ...
                                <div class="product-content">
                                    ...
                                    <h6 class="product-title"><a href="#">Gaming Controller</a></h6>
                                    <div class="product-price-variant">
                        ...
                        <div class="col">
                            <div class="axil-product-list">
                                ...
                                <div class="product-content">
                                    ...
                                    <h6 class="product-title"><a href="#">Wall Mount </a></h6>
                                    <div class="product-price-variant">
                        ...
                        <div class="col">
                            <div class="axil-product-list">
                                ...
                                <div class="product-content">
                                    ...
                                    <h6 class="product-title"><a href="#">Lenevo Laptop</a></h6>
                                    <div class="product-price-variant">
                        ...
                        <div class="col">
                            <div class="axil-product-list">
                                ...
                                <div class="product-content">
                                    ...
                                    <h6 class="product-title"><a href="#">Juice Grinder Machine</a></h6>
                                    <div class="product-price-variant">
                        ...
                        <div class="col">
                            <div class="axil-product-list">
                                ...
                                <div class="product-content">
                                    ...
                                    <h6 class="product-title"><a href="#">Asus Zenbook Laptop</a></h6>
                                    <div class="product-price-variant">
        ...
        <div class="axil-why-choose-area pb--50 pb_sm--30">
            <div class="container">
                <div class="section-title-wrapper section-title-center">
                    <span class="title-highlighter highlighter-secondary mt-3"><i class="fal fa-thumbs-up"></i>Why Us</span>
        ...
        <div class="cart-content-wrap">
            ...
            <div class="cart-body">
                <ul class="cart-item-list">
                    <li class="cart-item">
                        <div class="item-img">
                            <a href="#"><img src="assets/images/product/electric/product-01.png" alt="Commodo Blown Lamp"></a>
        ...
        <div class="offer-popup-wrap">
            <div class="card-body">
                ...
                <div class="content">
                    ...
                    <a href="our-products.php" class="axil-btn btn-bg-primary">Shop Now <i class="fal fa-long-arrow-right"></i></a>
                </div>
            </div>
        </div>
    </div>
...
<!-- Mirrored from new.axilthemes.com/demo/template/etrade/index-1.php by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 07 Dec 2023 13:33:06 GMT -->
</html>