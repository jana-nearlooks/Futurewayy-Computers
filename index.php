                            ...
                            <div class="slider-content-activation-one">
                                <div class="single-slide slick-slide" data-sal="slide-up" data-sal-delay="400" data-sal-duration="800">
                                    ...
                                    <div class="slide-action">
                                        <div class="shop-btn">
                                            <a href="shop.php" class="axil-btn btn-bg-white"><i class="fal fa-eye"></i>View</a>
                                        </div>
                        ...
                        <div class="main-slider-large-thumb">
                            <div class="slider-thumb-activation-one axil-slick-dots">
                                ...
                                <div class="single-slide slick-slide">
                                    ...
                                    <div class="product-price">
                                        <span class="text">From</span>
                                        <span class="price-amount">₹999.00</span>
                                    </div>
                                </div>
                                <div class="single-slide slick-slide">
                                    ...
                                    <div class="product-price">
                                        <span class="text">From</span>
                                        <span class="price-amount">₹499.00</span>
                                    </div>
                                </div>
                                <div class="single-slide slick-slide">
                                    ...
                                    <div class="product-price">
                                        <span class="text">From</span>
                                        <span class="price-amount">₹799.00</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row row--15">
                                ...
                                <div class="axil-product product-style-one">
                                    ...
                                    <div class="product-content">
                                        <div class="inner">
                                            ...
                                            <h5 class="title"><a href="#">Dell 4K Monitor</a></h5>
                                ...
                                <div class="axil-product product-style-one">
                                    <div class="thumbnail">
                                        ...
                                        <div class="product-hover-action">
                                            <ul class="cart-action">
                                                <li class="quickview"><a href="#" data-bs-toggle="modal" data-bs-target="#quick-view-modal"><i class="far fa-eye"></i></a></li>
                                                <li class="select-option"><a href="#">Get Quote</a></li>
                                                <li class="wishlist"><a href="wishlist.php"><i class="far fa-heart"></i></a></li>
                                            </ul>
                                        </div>
                                    </div>
                                    <div class="product-content">
                                        <div class="inner">
                                            <h5 class="title"><a href="#">Intex CPU i7</a></h5>
                                            <div class="product-price-variant">
                                                <span class="price current-price">$29.99</span>
                                                <span class="price old-price">₹100.99</span>
                                            </div>
                            ...
                            <div class="col-xl-3 col-lg-4 col-sm-6 col-12 mb--30">
                                <div class="axil-product product-style-one">
                                    ...
                                    <div class="product-content">
                                        <div class="inner">
                                            <h5 class="title"><a href="#">Rapoo Bluetooth with wireless</a></h5>
                                            <div class="product-price-variant">
                                                <span class="price current-price">₹1600</span>
                                                <span class="price old-price">₹2000</span>
                                            </div>
                                            <div class="color-variant-wrapper">
                                                <ul class="color-variant">
                                                    <li class="color-extra-01 active"><span><span class="color"></span></span>
                                ...
                                <div class="axil-product product-style-one">
                                    ...
                                    <div class="product-content">
                                        <div class="inner">
                                            ...
                                            <div class="product-price-variant">
                                                <span class="price current-price">₹3999</span>
                                                <span class="price old-price">₹9200</span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="col-xl-3 col-lg-4 col-sm-6 col-12 mb--30">
                                <div class="axil-product product-style-one">
                                    ...
                                    <div class="product-content">
                                        <div class="inner">
                                            <h5 class="title"><a href="#">Red Gear Gaming Joystick</a></h5>
                                            <div class="product-price-variant">
                                                <span class="price current-price">$29.99</span>
                                                <span class="price old-price">₹100.99</span>
                                            </div>
                                ...
                                <div class="axil-product product-style-one">
                                    ...
                                    <div class="product-content">
                                        <div class="inner">
                                            ...
                                            <h5 class="title"><a href="#">Quick Heal Antivirus</a></h5>
                                            <div class="product-price-variant">
                                                <span class="price current-price">$29.99</span>
                                                <span class="price old-price">₹100.99</span>
                                            </div>
                            ...
                            <div class="axil-product product-style-two">
                                ...
                                <div class="product-content">
                                    <div class="inner">
                                        ...
                                        <h5 class="title"><a href="#">Google Home</a></h5>
                                        <div class="product-price-variant">
                            ...
                            <div class="axil-product product-style-two">
                                ...
                                <div class="product-content">
                                    <div class="inner">
                                        ...
                                        <h5 class="title"><a href="#">Netfilx Remot</a></h5>
                                        <div class="product-price-variant">
                            ...
                            <div class="axil-product product-style-two">
                                ...
                                <div class="product-content">
                                    <div class="inner">
                                        ...
                                        <h5 class="title"><a href="#">Digital Accessories</a></h5>
                                        <div class="product-price-variant">
                            ...
                            <div class="axil-product product-style-two">
                                ...
                                <div class="product-content">
                                    <div class="inner">
                                        ...
                                        <h5 class="title"><a href="#">PS5 Smart Remote</a></h5>
                                        <div class="product-price-variant">
                                            <span class="price old-price">$50</span>
                        ...
                        <div class="col">
                            <div class="axil-product-list">
                                ...
                                <div class="product-content">
                                    ...
                                    <div class="product-price-variant">
                                        <span class="price current-price">₹100.99</span>
                                    </div>
                                    <div class="product-cart">
                                        <a href="cart.php" class="cart-btn"><i class="fal fa-shopping-cart"></i></a>
                                        <a href="wishlist.php" class="cart-btn"><i class="fal fa-heart"></i></a>
                                    ...
                                    <div class="inner">
                                        ...
                                        <div class="product-action-wrapper d-flex-center">
                                            ...
                                            <ul class="product-action d-flex-center mb--0">
                                                <li class="add-to-cart"><a href="cart.php" class="axil-btn btn-bg-primary">Get Quote</a></li>
        ...
        <div class="offer-popup-wrap">
            <div class="card-body">
                ...
                <div class="content">
                    ...
                    <a href="shop.php" class="axil-btn btn-bg-primary">Shop Now <i class="fal fa-long-arrow-right"></i></a>
                </div>
            </div>
        </div>
    </div>
